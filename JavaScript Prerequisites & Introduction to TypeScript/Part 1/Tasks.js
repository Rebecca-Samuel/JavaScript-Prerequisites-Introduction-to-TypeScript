...
// ─── Task 7 — ES Modules (see utils.js) ──────────────────────────────────────
//
//  This file (index.js) would live next to utils.js and use:
//
//    import formatCurrency, { add, capitalize, APP_VERSION } from "./utils.js"
//
//    console.log(add(10, 20))             // 30
//    console.log(capitalize("frontend"))  // Frontend
//    console.log(APP_VERSION)             // 1.0.0
//    console.log(formatCurrency(45000))   // ₦45,000.00
//
//  (Actual import/export syntax requires a module bundler or Node with
//   "type": "module" in package.json, so the live demo is in index.js.)